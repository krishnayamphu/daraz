...
<div class="container">
    <div class="row justify-content-between py-3">
        ...
        <div class="col">
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="${pageContext.servletContext.contextPath}/users"><i class="fa fa-eye"></i> All Users</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-9">
            <form class="row g-3" action="${pageContext.servletContext.contextPath}/admin/edit/${admin.id}" method="post">
                ${errUser}
