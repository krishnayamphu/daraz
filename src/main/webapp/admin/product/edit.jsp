...
<div class="container">
    <div class="row justify-content-between py-3">
        <div class="col"><h5>Product Details</h5></div>
        <div class="col">
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="${rootPath}/admin/products"><i class="fa fa-eye"></i> All
                        Products</a>
                </li>
            </ul>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-9">
            <form class="row g-3" action="${rootPath}/admin/product-edit" method="post">
                ...
                <div class="col-4">
                    ...
                    <input type="number" class="form-control" name="rg_price" value="${product.regularPrice}" required>
                </div>
                <div class="col-4">
                    <label class="form-label">Sales Price</label>
                    <input type="number" class="form-control" name="sa_price" value="${product.salesPrice}" required>
                </div>
                <div class="col-12">
                    <label class="form-label">Description</label>
                    <textarea class="form-control" name="desc"  cols="30" rows="10">${product.description}</textarea>
                </div>
                <div class="col-4">
                    ...
                    <select class="form-select" aria-label="Default select example" name="cat_id">
                        ...
                        <c:forEach var="category" items="${categories}">
                            <c:forEach var="item" items="${product.getCategories(product.id)}">
                                <option  value="${category.id}" ${category.name == item ? 'selected' : ''} >${category.name}</option>
                            </c:forEach>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="imgName" value="${product.image}" name="image">
